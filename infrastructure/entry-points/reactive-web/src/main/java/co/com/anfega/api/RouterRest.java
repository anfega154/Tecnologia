...
public class RouterRest {
    ...
    public RouterFunction<ServerResponse> routerFunction(Handler handler) {
        return route(POST(technologyPath.getTechnologies()), handler::listenSaveTechnologyUseCase)
                .andRoute(GET(technologyPath.getTechnologies()), handler::listenGetAllTechnologiesUseCase)
                .andRoute(DELETE(technologyPath.getTechnologies()), handler::listenDeleteTechnologiesByIds);
    }
}
